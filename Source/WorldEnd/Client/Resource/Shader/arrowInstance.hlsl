 ...
 *  ARROW_INSTANCE
 */
struct VS_ARROW_INSTANCE_INPUT
{
...
struct VS_ARROW_INSTANCE_OUTPUT
{
...
VS_ARROW_INSTANCE_OUTPUT VS_ARROW_INSTANCE_MAIN(VS_ARROW_INSTANCE_INPUT input)
{
	VS_ARROW_INSTANCE_OUTPUT output;
...
[earlydepthstencil]
float4 PS_ARROW_INSTANCE_MAIN(VS_ARROW_INSTANCE_OUTPUT input) : SV_TARGET
{
