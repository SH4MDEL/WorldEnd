	...
	const ComPtr<ID3D12RootSignature>& rootsignature, const ComPtr<ID3D12RootSignature>& postRootSignature)
{
	...
	//LoadMaterialFromFile(device, commandlist, TEXT("./Resource/Texture/VillageSceneTexture/MV_Tree_A_01Texture.bin"));
	//LoadMaterialFromFile(device, commandlist, TEXT("./Resource/Texture/VillageSceneTexture/MV_Tree_A_02Texture.bin"));
	//LoadMaterialFromFile(device, commandlist, TEXT("./Resource/Texture/VillageSceneTexture/MV_Tree_A_03Texture.bin"));
	//LoadMaterialFromFile(device, commandlist, TEXT("./Resource/Texture/VillageSceneTexture/MV_Tree_A_04Texture.bin"));
	//LoadMaterialFromFile(device, commandlist, TEXT("./Resource/Texture/VillageSceneTexture/MV_Tree_B_01Texture.bin"));
	//LoadMaterialFromFile(device, commandlist, TEXT("./Resource/Texture/VillageSceneTexture/MV_Tree_B_02Texture.bin"));
	//LoadMaterialFromFile(device, commandlist, TEXT("./Resource/Texture/VillageSceneTexture/MV_Tree_B_03Texture.bin"));
	//LoadMaterialFromFile(device, commandlist, TEXT("./Resource/Texture/VillageSceneTexture/MV_Tree_B_04Texture.bin"));
	...
	//LoadMeshFromFile(device, commandlist, TEXT("./Resource/Mesh/VillageSceneMesh/MV_Tree_A_01Mesh.bin"));
	//LoadMeshFromFile(device, commandlist, TEXT("./Resource/Mesh/VillageSceneMesh/MV_Tree_A_02Mesh.bin"));
	//LoadMeshFromFile(device, commandlist, TEXT("./Resource/Mesh/VillageSceneMesh/MV_Tree_A_03Mesh.bin"));
	//LoadMeshFromFile(device, commandlist, TEXT("./Resource/Mesh/VillageSceneMesh/MV_Tree_A_04Mesh.bin"));
	//LoadMeshFromFile(device, commandlist, TEXT("./Resource/Mesh/VillageSceneMesh/MV_Tree_B_01Mesh.bin"));
	//LoadMeshFromFile(device, commandlist, TEXT("./Resource/Mesh/VillageSceneMesh/MV_Tree_B_02Mesh.bin"));
	//LoadMeshFromFile(device, commandlist, TEXT("./Resource/Mesh/VillageSceneMesh/MV_Tree_B_03Mesh.bin"));
	//LoadMeshFromFile(device, commandlist, TEXT("./Resource/Mesh/VillageSceneMesh/MV_Tree_B_04Mesh.bin"));
